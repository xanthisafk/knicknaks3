...
| —      | **Color Blindness Simulator**  | View hex colors or images as seen by protanopia, deuteranopia, etc.               |
| —      | **Pantone Color Matcher**      | Find the closest Pantone match for any HEX/RGB value.                             |
| —      | **OKLCH Color Picker**         | Modern perceptual color space editor for designers.                               |
| —      | **Material Design Palette**    | Official Material 2 and Material 3 (M3) color generator.                          |
| —      | **Brand Colors Reference**     | Searchable database of 1000+ official brand color guidelines.                     |
| —      | **Color Shades & Tints**       | Generate 10-20 incremental variations of a single base color.                     |
| —      | **Accessible Palette Builder** | Generate an entire palette specifically optimized for WCAG compliance.            |
| —      | **Color Name Search**          | Find the specific human-readable name for any Hex code.                           |
| —      | **HWB Color Picker**           | Hue-Whiteness-Blackness adjustment tool for intuitive color picking.              |
| —      | **Color Blender / Mixer**      | Mix two colors together with configurable transition steps.                       |
| —      | **LCH / Lab Explorer**         | Explore device-independent color spaces (CIELAB/CIELCH).                          |
| —      | **System Interface Colors**    | Standard UI color references for Windows, macOS, iOS, and Android.                |
| —      | **Vibrant Image Colors**       | Extract dominant and high-vibrancy accent colors from an image.                   |
| —      | **Color Trend Explorer**       | Discover curated trending palettes based on popular design systems.               |
| —      | **Color Harmony Wheel**        | Interactive wheel for Triadic, Analogous, and Tetradic design rules.              |
...
| ✅     | **Calorie Calculator**      | Daily calorie needs based on activity and goals.               |
| ✅     | **Body Fat Calculator**     | Estimates body fat percentage using US Navy method.            |
| ✅     | **BMR Calculator**          | Basal Metabolic Rate using Mifflin-St Jeor or Harris-Benedict. |
| ✅     | **Ideal Weight Calculator** | Find your healthy weight range based on height and gender.     |
| ✅     | **Pace Calculator**         | Calculate running pace, time, or distance for training.        |
...
| Status | Tool            | Description                                                         |
| ------ | --------------- | ------------------------------------------------------------------- |
| ✅     | **IPTV Player** | Browser-based HLS video player. Load custom M3U playlists directly. |
