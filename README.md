...
- **Fast & Lightweight**: Built with Astro and React for optimal performance.
...
1. Clone the repository:
   ```sh
   git clone https://github.com/xanthis/knicknaks.git
   ```
...
- [React](https://reactjs.org/) - For interactive tool components.
- [Tailwind CSS](https://tailwindcss.com/) - For a modern and responsive design.
- [TypeScript](https://www.typescriptlang.org/) - For type safety and better developer experience.

## 🤝 Contributing

Contributions are welcome! Please see our [Contributing Guidelines](.github/CONTRIBUTING.md) for more details.
