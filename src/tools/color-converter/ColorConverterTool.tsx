  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* RGB */}
        <Panel>
          <h3 className="text-sm font-medium text-[var(--text-primary)] mb-3">RGB</h3>
        ...
        {/* HSL */}
        <Panel>
          <h3 className="text-sm font-medium text-[var(--text-primary)] mb-3">HSL</h3>
          <div className="space-y-2">
            {([
        ...
        {/* CMYK */}
        <Panel>
          <h3 className="text-sm font-medium text-[var(--text-primary)] mb-3">CMYK</h3>
          <div className="space-y-2">
      ...
      {/* All values summary */}
      <Panel>
        <h3 className="text-sm font-medium text-[var(--text-primary)] mb-3">All Values</h3>
        <div className="space-y-2">
